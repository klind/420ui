...
export class SurveyService {
    private surveysURL = 'http://localhost:8080/mms/api/surveys';  // URL to web api
    private answerURL = 'http://localhost:8080/mms/api/answers';  // URL to web api
    constructor(private http:Http) {
    }


    saveSurveyAnswer(model:Answer) {
        ...
        return this.http.post(this.answerURL, body, options)
